...
pub type GF = Fp<4, P>;
pub type Poseidon = GenericPoseidon<'static, 2, 3, 91, GF>;

pub fn new(state: [GF; 3]) -> Poseidon {
    Poseidon {
        state: state,
        constants: &CONSTANTS,
    }
